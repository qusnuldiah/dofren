...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
    ...
    <div class="group relative overflow-hidden rounded-3xl p-6 shadow-sm border border-white/80 bg-gradient-to-br from-white via-[#FFF1EB]/80 to-white animate-gradient-pan hover:shadow-[0_8px_30px_rgba(255,122,0,0.1)] hover:-translate-y-1 transition-all duration-300 z-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-5">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-500 mb-1">Total Kategori</p>
                <h3 class="text-3xl font-heading font-bold text-[#3D1A10]">{{ $totalCategories }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="group relative overflow-hidden rounded-3xl p-6 shadow-sm border border-white/80 bg-gradient-to-br from-white via-[#FFF1EB]/80 to-white animate-gradient-pan hover:shadow-[0_8px_30px_rgba(255,122,0,0.1)] hover:-translate-y-1 transition-all duration-300 z-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-5">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-500 mb-1">Produk Bestseller</p>
                <h3 class="text-3xl font-heading font-bold text-[#3D1A10]">{{ $totalBestsellers }}</h3>
            </div>
        </div>
    </div>
</div>
