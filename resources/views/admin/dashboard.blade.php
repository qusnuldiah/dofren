...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
    ...
    <!-- Produk -->
    <div class="group relative overflow-hidden rounded-3xl p-4 sm:p-6 shadow-sm border border-white/80 bg-gradient-to-br from-white via-[#FFF1EB]/80 to-white animate-gradient-pan hover:shadow-[0_8px_30px_rgba(255,122,0,0.1)] hover:-translate-y-1 transition-all duration-300 z-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 sm:gap-5">
            <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-orange-50 flex items-center justify-center text-[#FF7A00] shrink-0">
            ...
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-heading font-bold text-[#3D1A10]">{{ $totalProducts }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="group relative overflow-hidden rounded-3xl p-4 sm:p-6 shadow-sm border border-white/80 bg-gradient-to-br from-white via-[#FFF1EB]/80 to-white animate-gradient-pan hover:shadow-[0_8px_30px_rgba(255,122,0,0.1)] hover:-translate-y-1 transition-all duration-300 z-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 sm:gap-5">
            ...
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-heading font-bold text-[#3D1A10]">{{ $totalCategories }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="group relative overflow-hidden rounded-3xl p-4 sm:p-6 shadow-sm border border-white/80 bg-gradient-to-br from-white via-[#FFF1EB]/80 to-white animate-gradient-pan hover:shadow-[0_8px_30px_rgba(255,122,0,0.1)] hover:-translate-y-1 transition-all duration-300 z-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 sm:gap-5">
            ...
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-heading font-bold text-[#3D1A10]">{{ $totalBestsellers }}</h3>
            </div>
        </div>
    </div>
</div>
