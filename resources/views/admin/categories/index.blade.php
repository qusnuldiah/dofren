                        ...
                        <tr class="hover:bg-orange-50/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.categories.edit', $category) }}" aria-label="Edit Kategori {{ $category->name }}" title="Edit" class="p-2 rounded-xl bg-slate-100 hover:bg-orange-50 hover:text-[#FF7A00] text-slate-500 transition-colors">
                                    ...
                                    <button type="button" aria-label="Hapus Kategori {{ $category->name }}" title="Hapus" 
    ...
    @else
        <div class="py-16 text-center">
            <div class="flex justify-center mb-4 text-[#FF7A00]">
                <svg aria-hidden="true" class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
            </div>
    ...
    <div @click.away="show = false" class="bg-white rounded-3xl p-6 shadow-2xl max-w-md w-full mx-4 border border-red-100" x-show="show" x-transition>
        <div class="flex items-start gap-4 mb-5">
            <div class="w-12 h-12 rounded-full bg-red-100 text-red-600 flex items-center justify-center flex-shrink-0 mt-1">
                <svg aria-hidden="true" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
            </div>
            <div>
